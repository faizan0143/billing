                ...
                <?php echo $this->include('message'); ?>
                    <div class="card card-primary card-outline">
                        <div class="pt-2 pb-2">
                            ...
                            <form action="<?php echo base_url('admin/category/update/'). $res['category_id']; ?>" method="post" autocomplete="off">
                            
                                <div class="container">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="">Category Name : <span class="text-red">*</span></label>
                                            <input type="text" name="category_name" class="form-control" value="<?php echo set_value('category_name', $res['category_name']); ?>" placeholder="Enter Category">
                                    ...
                                    <div class="row">
                                    <div class="col-md-3">
                                        <a href="#"><button class="btn btn-primary btn-block"><b>Update Category</b></button></a>
                                    </div>
                                    <div class="col-md-3">
                                        <a href="<?php echo base_url('admin/category/view'); ?>" class="btn btn-danger"><b>Back</b></a>
                                    </div>
                                </div>
