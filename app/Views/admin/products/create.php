                ...
                <?php echo $this->include('message'); ?>
                    <div class="card card-primary card-outline">
                        <div class="pt-2 pb-2">
                            ...
                            <form action="<?php echo base_url('admin/products/name/store'); ?>" method="post" autocomplete="off">
                                ...
                                <div class="container">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="category_id" class="form-control">
                                                ...
                                                <option value="<?php echo $res[$i]['category_id'] ; ?>"><?php echo $res[$i]['category_name'] ; ?></option>
                                    ...
                                    <div class="row">
                                    <div class="col-md-4">
                                        <a href="#"><button class="btn btn-primary btn-block"><b>Add Product Name</b></button></a>
                                    </div>
                                </div>
