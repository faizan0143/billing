                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('admin/products/name/edit/'. $val['product_id']); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;
                                                    <!--<a href="#" onClick="deleteConfirm(<?= $val['product_id'] ?>)" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="fa fa-trash"></i></a>-->
                                                </td>
                                            </tr>
                                        <?php
                                        }
...
<script>
  function deleteConfirm(id) {
    ...
    if (confirm("Are You Sure! You want to delete?")) {
      window.location.href = '<?= base_url('admin/products/name/delete/') ?>/' + id
    }
  }
</script>